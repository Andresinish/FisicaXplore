...
?>
	...
	<script>
		function Comprobar() {
				...
				var resultadoC = parseFloat(<?=$ResultadoOperacion[2]?>)
				var valorCajaC = document.getElementById("c)").value

				if (valorCajaC.includes("x10^")) 
				{
					var elementosC = valorCajaC.split("x10^")
					var numeroC = elementosC[0]
					var potenciaC= elementosC[1]

					var resultadoUC = numeroC * (Math.pow(10, potenciaC))
					
					if(resultadoUC == resultadoC)
					{
